...
{
    public abstract class DoubleDictionary
    {
        public abstract string ValueDictionary(double value); 
    }

    public class Dictionary : DoubleDictionary
    {
        ...
        public override string ValueDictionary(double number)
        {
