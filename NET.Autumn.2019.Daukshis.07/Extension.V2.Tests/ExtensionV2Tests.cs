...
namespace Extension.V2.Tests
{
    ...
    public class ExtensionV2Tests
    {
        ...
        public int FindGcdByEuclidean_2Numbers(int number1, int number2)
        {
            ...
            return algorithm.Gcd(number1, number2);
        }
        ...
        {
            IAlgorithm algorithm = new EuclideanAlgorithm();
            return algorithm.Gcd(number1, number2, number3);
        }
        ...
        {
            IAlgorithm algorithm = new EuclideanAlgorithm();
            int result = algorithm.Gcd(out long milliseconds, number1, number2);
        ...
        {
            IAlgorithm algorithm = new EuclideanAlgorithm();
            int result = algorithm.Gcd(out long milliseconds, number1, number2, number3);
            Assert.GreaterOrEqual(milliseconds, 0);
            return result;
        }
        ...
        {
            IAlgorithm algorithm = new EuclideanAlgorithm();
            int result = algorithm.Gcd(out long milliseconds, array);
            Assert.GreaterOrEqual(milliseconds, 0);
            return result;
        }
    }
